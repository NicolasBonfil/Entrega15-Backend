...
const authorized = () => {
    return (req, res, next) => {
        ...
        // const opcionesEsperadas = ['Identificacion', 'Comprobante de domicilio', 'Comprobante de estado de cuenta'];
        // const alMenosUnNombreEncontrado = opcionesEsperadas.some(opcion => nombres.includes(opcion));
        // console.log(alMenosUnNombreEncontrado);
